...
import { ONE_OF_KEY, ID_KEY } from "../schema.js";
...
export const ONE_OF_SCHEMA_OPTIONS = oneOfSchema[ONE_OF_KEY];
export const FIRST_ONE_OF = ONE_OF_SCHEMA_OPTIONS[0];
export const SECOND_ONE_OF = ONE_OF_SCHEMA_OPTIONS[1];
export const OPTIONAL_ONE_OF_SCHEMA = deepFreeze({
    oneOf: [
        {
            type: "object",
            properties: {
...
export const OPTIONAL_ONE_OF_SCHEMA_ONEOF = OPTIONAL_ONE_OF_SCHEMA[ONE_OF_KEY];
...
//   []
// );
export const SUPER_SCHEMA = deepFreeze({
    [ID_KEY]: "super-schema",
    definitions: {
        test: {
            type: "string",
...
export const PROPERTY_DEPENDENCIES = deepFreeze({
    type: "object",
    properties: {
        a: { type: "string" },
        b: { type: "integer" },
...
export const SCHEMA_DEPENDENCIES = deepFreeze({
    type: "object",
    properties: {
        a: { type: "string" },
    },
...
export const SCHEMA_AND_ONEOF_REF_DEPENDENCIES = deepFreeze({
    type: "object",
    definitions: {
        needsA: {
            properties: {
...
export const SCHEMA_AND_REQUIRED_DEPENDENCIES = deepFreeze({
    type: "object",
    properties: {
        a: { type: "string" },
        b: { type: "integer" },
...
export const SCHEMA_WITH_ONEOF_NESTED_DEPENDENCIES = deepFreeze({
    type: "object",
    dependencies: {
        employee_accounts: {
            oneOf: [
...
export const SCHEMA_WITH_SINGLE_CONDITION = deepFreeze({
    type: "object",
    properties: {
        country: {
...
export const SCHEMA_WITH_MULTIPLE_CONDITIONS = deepFreeze({
    type: "object",
    properties: {
        Animal: {
            default: "Cat",
...
export const SCHEMA_WITH_NESTED_CONDITIONS = deepFreeze({
    type: "object",
    properties: {
        country: {
            enum: ["USA"],
...
export const SCHEMA_WITH_ARRAY_CONDITION = deepFreeze({
    type: "object",
    properties: {
        list: {
            type: "array",
...
export const SCHEMA_WITH_ALLOF_CANNOT_MERGE = deepFreeze({
    type: "object",
    properties: {
        animal: {
            enum: ["Cat", "Fish"],
