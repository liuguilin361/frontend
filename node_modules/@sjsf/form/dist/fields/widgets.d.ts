...
import type { ComponentProps, Config, FieldError, FoundationalComponentType, SchemaValue, UiOption } from "../form/index.js";
...
export type FoundationalWidgetType = {
    [K in FoundationalComponentType]: ComponentProps[K] extends WidgetCommonProps<any> ? WidgetCommonProps<any> extends ComponentProps[K] ? K : never : never;
