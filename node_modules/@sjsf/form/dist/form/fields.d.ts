import type { SchemaValue, SchemaArrayValue, SchemaObjectValue } from "../core/index.js";
...
export type FoundationalFieldType = {
    [K in FoundationalComponentType]: FieldCommonProps<any> extends ComponentProps[K] ? ComponentProps[K] extends FieldCommonProps<any> ? K : never : never;
